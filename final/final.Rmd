...
library(tidyverse)
library(here)
enflasyon_türkiye_kanada_fransa_almanya_italya_hollanda_isveç_avusturya_bk_abd_csv(here("../data/(enflasyon_türkiye_kanada_fransa_almanya_italya_hollanda_isveç_avusturya_bk_abd.csv"))
```
